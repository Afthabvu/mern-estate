  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input  type="email" placeholder="email" id="email" className="border p-2 rounded-lg" defaultValue={currentUser.email} onChange={handleChange}/>
      ...
      <div className="flex justify-between mt-5">
        ...
        <p className="text-green-700">{updateSuccess?'Update Succesfull':''}</p>
    </div>
  )
}
